...
save_path = "../data/VOC2007"
img_size = (512, 512)
channels = 3
num_classes = 4


train_txt_path = "../data/VOC2007/ImageSets/Segmentation/train.txt"
test_txt_path = "../data/VOC2007/ImageSets/Segmentation/test.txt"
val_txt_path = "../data/VOC2007/ImageSets/Segmentation/val.txt"
