...
from models.MobileSAMv2.efficientvit.models.efficientvit.backbone import EfficientViTBackbone, EfficientViTLargeBackbone
from models.MobileSAMv2.efficientvit.models.nn import (
    ConvLayer,
    DAGBlock,
    FusedMBConv,
    IdentityLayer,
...
from models.MobileSAMv2.efficientvit.models.utils import build_kwargs_from_config
...
def efficientvit_seg_b0(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.MobileSAMv2.efficientvit.models.efficientvit.backbone import efficientvit_backbone_b0
...
def efficientvit_seg_b1(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.MobileSAMv2.efficientvit.models.efficientvit.backbone import efficientvit_backbone_b1
...
def efficientvit_seg_b2(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.MobileSAMv2.efficientvit.models.efficientvit.backbone import efficientvit_backbone_b2
...
def efficientvit_seg_b3(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.MobileSAMv2.efficientvit.models.efficientvit.backbone import efficientvit_backbone_b3
...
def efficientvit_seg_l1(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.MobileSAMv2.efficientvit.models.efficientvit.backbone import efficientvit_backbone_l1
...
def efficientvit_seg_l2(dataset: str, **kwargs) -> EfficientViTSeg:
    from models.MobileSAMv2.efficientvit.models.efficientvit.backbone import efficientvit_backbone_l2
