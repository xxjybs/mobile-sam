...
from models.cross_attention import ConvPromptAdapter as addtion_adapter
...
class PromptGenerator(nn.Module):
    def __init__(self, scale_factor, prompt_type, embed_dims, tuning_stage, depths, input_type,
        ...
        self.cross_attention = addtion_adapter()
        ...
        if self.handcrafted_tune:
            ...
            if '4' in self.tuning_stage:
                self.handcrafted_generator4 = OverlapPatchEmbed(img_size=img_size // 16, patch_size=3, stride=1,
